...
curl -L -X PUT -H "Accept: application/vnd.github+json" -H "Authorization: Bearer <YOUR-TOKEN>" -H "X-GitHub-Api-Version: 2022-11-28"  https://api.github.com/orgs/ORG/$Orgname/ConED_Dev/repos/prad6588/$Destination_Reponame -d '{"permission":"push"}'
