...
#curl -L -X PUT -H "Accept: application/vnd.github+json" -H "Authorization: Bearer $GITHUB_TOKEN" -H "X-GitHub-Api-Version: 2022-11-28" https://api.github.com/orgs/$Orgname/teams/collaborators/$Team_Permission -d '{"permission":"triage"}'
curl -L -X PUT -H "Accept: application/vnd.github+json" -H "Authorization: Bearer $GITHUB_TOKEN" -H "X-GitHub-Api-Version: 2022-11-28"  https://api.github.com/orgs/$Orgname/teams/ConED_Dev/repos/pradeep6588/$Destination_Reponame -d '{"permission":"push"}'
